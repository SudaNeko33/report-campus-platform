          ...
          <div class="rounded-lg shadow-sm -space-y-px">
            <div>
              ...
              <input
                ...
                type="text"
                required
                class="appearance-none rounded-none relative block w-full px-5 py-4 text-lg border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 focus:z-10"
                placeholder="用户名"
              />
            </div>
            <div>
              ...
              <input
                ...
                type="password"
                required
                class="appearance-none rounded-none relative block w-full px-5 py-4 text-lg border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 focus:z-10"
                placeholder="密码"
              />
            </div>
          </div>
