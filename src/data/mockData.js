...
export const users = [
  { user_id: 1, username: 'zhangsan', password: 'encrypted', real_name: '张三', student_id: '2021001', contact: 'zhangsan@qq.com', role: '学生', status: '正常', create_time: '2024-01-10 10:00:00', score: 4.8 },
  { user_id: 2, username: 'lisi', password: 'encrypted', real_name: '李四', student_id: '2021002', contact: 'lisi_wechat', role: '学生', status: '正常', create_time: '2024-01-15 14:30:00', score: 4.5 },
  { user_id: 3, username: 'wangwu', password: 'encrypted', real_name: '王五', student_id: '2021003', contact: 'wangwu_qq', role: '学生', status: '正常', create_time: '2024-02-01 09:00:00', score: 5.0 },
  { user_id: 4, username: 'admin', password: 'encrypted', real_name: '管理员', student_id: 'admin001', contact: 'admin@edu.cn', role: '管理员', status: '正常', create_time: '2024-01-01 00:00:00', score: 5.0 }
]

export const goods = [
  { goods_id: 1, user_id: 1, category_id: 1, goods_name: 'iPhone 14 Pro 256G', description: '使用一年，电池健康度92%，无磕碰，配件齐全', price: 5800, images: 'https://neeko-copilot.bytedance.net/api/text_to_image?prompt=iPhone%2014%20Pro%20smartphone%20product%20photo&image_size=square', status: '已上架', create_time: '2024-03-01 10:00:00', update_time: '2024-03-01 10:00:00', campus: '邯郸' },
  { goods_id: 2, user_id: 1, category_id: 2, goods_name: '高等数学（第七版）上下册', description: '同济大学高等数学，无笔记，品相良好', price: 45, images: 'https://neeko-copilot.bytedance.net/api/text_to_image?prompt=math%20textbook%20higher%20mathematics&image_size=square', status: '已上架', create_time: '2024-03-05 15:30:00', update_time: '2024-03-05 15:30:00', campus: '邯郸' },
  { goods_id: 3, user_id: 2, category_id: 3, goods_name: '宜家书桌', description: '白色简约书桌，尺寸120x60cm，可拆卸', price: 180, images: 'https://neeko-copilot.bytedance.net/api/text_to_image?prompt=white%20IKEA%20desk%20minimalist%20style&image_size=square', status: '已上架', create_time: '2024-03-10 09:00:00', update_time: '2024-03-10 09:00:00', campus: '江湾' },
  { goods_id: 4, user_id: 2, category_id: 4, goods_name: '羽毛球拍套装', description: '尤尼克斯羽毛球拍，含球和拍套', price: 260, images: 'https://neeko-copilot.bytedance.net/api/text_to_image?prompt=badminton%20racket%20set%20sports%20equipment&image_size=square', status: '已上架', create_time: '2024-03-12 11:00:00', update_time: '2024-03-12 11:00:00', campus: '张江' },
  ...
  { goods_id: 6, user_id: 3, category_id: 1, goods_name: 'MacBook Air M2', description: '13.6英寸，8GB+256GB，带原装充电器', price: 7200, images: 'https://neeko-copilot.bytedance.net/api/text_to_image?prompt=MacBook%20Air%20M2%20laptop%20silver%20color&image_size=square', status: '已上架', create_time: '2024-03-15 10:00:00', update_time: '2024-03-15 10:00:00', campus: '邯郸' },
