...
export const users = [
  { user_id: 1, username: 'zhangsan', password: 'emhhbmdzYW4xMjM=', real_name: '张三', student_id: '2021001', contact: 'zhangsan@qq.com', role: '学生', status: '正常', create_time: '2024-01-10 10:00:00' },
  { user_id: 2, username: 'lisi', password: 'bGlzaTEyMw==', real_name: '李四', student_id: '2021002', contact: 'lisi_wechat', role: '学生', status: '正常', create_time: '2024-01-15 14:30:00' },
  { user_id: 3, username: 'wangwu', password: 'd2FuZ3d1MTIz', real_name: '王五', student_id: '2021003', contact: 'wangwu_qq', role: '学生', status: '正常', create_time: '2024-02-01 09:00:00' },
  { user_id: 4, username: 'admin', password: 'YWRtaW4xMjM=', real_name: '管理员', student_id: 'admin001', contact: 'admin@edu.cn', role: '管理员', status: '正常', create_time: '2024-01-01 00:00:00' }
]
...
export const goods = [
  ...
  { goods_id: 5, user_id: 3, category_id: 5, goods_name: 'Nike Air Force 1', description: '白色42码，穿过几次，几乎全新', price: 550, images: '/src/assets/nikeairforce.webp', status: '已售出', create_time: '2024-02-28 14:00:00', update_time: '2024-03-08 16:00:00', campus: '枫林' },
  ...
  { goods_id: 7, user_id: 1, category_id: 3, goods_name: '小米台灯Pro', description: '护眼台灯，多种色温调节', price: 120, images: '/src/assets/xiaomilamp.jpg', status: '暂存（已联系）', create_time: '2024-03-06 16:00:00', update_time: '2024-03-14 10:00:00', campus: '江湾' },
  { goods_id: 8, user_id: 2, category_id: 2, goods_name: '线性代数及其应用', description: '英文原版，适合双语教学使用', price: 85, images: '/src/assets/linearalgebrabook.webp', status: '待审核', create_time: '2024-03-16 09:00:00', update_time: '2024-03-16 09:00:00', campus: '张江' },
